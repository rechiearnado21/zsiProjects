        ...
        var _sqlCode  = "V1349" 
                ...
                case "Recent Collection":  
                    ...
                    switch (gSubTabName) { 
                        case "Collection Summary":   
                            ...
                            $("#dd_Div,#dateDiv,#vehicleHistorySummDiv").hide(); 
                            $("#vehicleRecentSummDiv,#gridDailyFareCollections,.btnSaveSumm").show();  
                            break;
                ...
                case "History Collection":  
                    ...
                    switch (gSubTabName) {  
                        case "Collection Summary":   
                            ...
                            $("#dd_Div,#dateDiv,#vehicleRecentSummDiv,.btnSaveSumm").hide(); 
                            $("#vehicleHistorySummDiv,#gridDailyFareCollections").show();  
                           ...
                           {text:"No."                                       ,width:60         ,style:"text-align:center"
                                ,onRender : function(d){ 
                                        return  _ctr++
                                               ...
                                               + app.bs({name:"payment_date"                    ,type:"hidden"      ,value: _todate})
                            ...
                            ,{text: "Driver"                                    ,width : 180            ,style : "text-align:left;"  ,sortColNo: 9
                                ,onRender: function(d){
                                    return app.svn(d,"driver_name")
                                         + app.bs({name:"driver_id"             ,type:"hidden"          ,value: app.svn(d,"driver_id")});
                                } 
                            } 
                            ,{text: "PAO"                                       ,width : 180            ,style : "text-align:left;" ,sortColNo: 11 
                                 ,onRender: function(d){
                                    return  app.svn(d,"pao_name")
                                         + app.bs({name:"pao_id"                ,type:"hidden"          ,value: app.svn(d,"pao_id")})
                                    ;
                                } 
                            }
                            ,{text: "QR Amount"                                 ,width : 100            ,sortColNo: 2 
                                ,onRender: function(d){
                                    return app.svn(d,"qr_sales") ? app.svn(d,"qr_sales").toMoney() : 0.00  ;//app.bs({name: "qr_amt"               ,type: "input"          ,value: app.svn(d,"qr_sales") ? app.svn(d,"qr_sales").toMoney() : 0.00    ,style : "text-align:right;padding-right: 0.3rem;" });
                                } 
                            }
                            ,{text: "POS Amount"                                ,width : 100            ,sortColNo: 1 
                                ,onRender: function(d){
                                    return app.svn(d,"cash_sales") ? app.svn(d,"cash_sales").toMoney() : 0.00;//app.bs({name: "pos_cash_amt"         ,type: "input"          ,value: app.svn(d,"cash_sales") ? app.svn(d,"cash_sales").toMoney() : 0.00    ,style : "text-align:right;padding-right: 0.3rem;" });
                                } 
                            } 
                             ,{text: "Shortage"                          ,type:"input"           ,width : 100     ,sortColNo: 4 
                                ,onRender: function(d){
                            ...
                            ,{text: "Excess"                             ,type:"input"           ,width : 100     ,sortColNo: 3 
                                ,onRender: function(d){
                            ...
                            ,{text: "Total Collections"                ,width : 120    ,style : "text-align:right;"  ,sortColNo: 6
                                ,onRender: function(d){
                                    return app.svn(d,"total_sales") ? app.svn(d,"total_sales").toMoney() : 0.00 ;//app.bs({name: "total_collection_amt"          ,type: "input"          ,value: app.svn(d,"total_sales") ? app.svn(d,"total_sales").toMoney() : 0.00    ,style : "text-align:right;padding-right: 0.3rem;" });
                                } 
                            } 
                ...
                if(gSubTabName === "Collection Summary" && _sqlCode === "P1442"){  
                        _dataRows.push(
                            ...
                            ,{text: "Payment Date"              ,width : 100       ,sortColNo: 1 
                                ,onRender: function(d){
                                    return app.bs({name: "payment_date"         ,type: "input"     ,value: app.svn(d,"payment_date").toShortDate()  ,style : "text-align:center;"});
                                }
                            }
                            ,{text: "Vehicle"                   ,name:"vehicle_plate_no"        ,type:"input"       ,width : 120    ,style : "text-align:center;"  ,sortColNo: 2 
                                , onRender      : function(d) {  
                                        return "<a style='text-decoration:underline !important;' href='javascript:void(0)'  onclick='fc.displayColDtls(\""+ app.svn (d,"vehicle_id") +"\",\""+ app.svn (d,"driver_id") +"\",\""+ app.svn (d,"pao_id") +"\");'>" + app.svn (d,"vehicle_plate_no") + "</a>";
                                }
                            }
                            ,{text: "Driver"                    ,name:"driver_name"             ,type:"input"       ,width : 180    ,style : "text-align:left;"  ,sortColNo: 4} 
                            ,{text: "PAO"                       ,name:"pao_name"                ,type:"input"       ,width : 180    ,style : "text-align:left;" ,sortColNo: 5}
                            ,{text: "QR Amount"                         ,width : 120    ,style : "text-align:left;" ,sortColNo: 9 
                                ,onRender: function(d){
                            ...
                            ,{text: "POS Amount"                        ,width : 120    ,style : "text-align:left;" ,sortColNo: 10
                                ,onRender: function(d){
                            ...
                            ,{text: "Shortage Amount"                 ,type:"input"       ,width : 120    ,style : "text-align:left;" ,sortColNo: 11 
                                ,onRender: function(d){
                                    return app.bs({name: "shortage_amt"   ,type: "input"     ,value: app.svn(d,"shortage_amt") ? app.svn(d,"shortage_amt").toMoney() : 0.00    ,style : "text-align:right;padding-right: 0.3rem;" });
                                } 
                            } 
                            
                            ,{text: "Excess Amount"                 ,type:"input"       ,width : 120    ,style : "text-align:left;" ,sortColNo: 12 
                                ,onRender: function(d){
                                    return app.bs({name: "excess_amt"   ,type: "input"     ,value: app.svn(d,"excess_amt") ? app.svn(d,"excess_amt").toMoney() : 0.00    ,style : "text-align:right;padding-right: 0.3rem;" });
                                } 
                            } 
                            ,{text: "Total Collection Amount"            ,width : 120    ,style : "text-align:left;" ,sortColNo: 13
                                ,onRender: function(d){
            ...
            $("#gridDailyFareCollections").dataBind({
                ...
                ,onComplete: function(o){
                    ...
                    var _rows;
                    var _counter    = 1;
                    var _tot        = {reg:0,stu:0,sc:0,pwd:0,total:0,reg_no:0,stu_no:0,sc_no:0,pwd_no:0,stod:0,edo:0,kms:0,tca:0,sales:0}; 
                    var _total      = {}; 
                    var _h          = "";
                    var _dataRecentDD;
                    var _dataHistoryDD;
                    ...
                    if( _sqlCode==="P1443"){
                        _h  +=  '<div class="zRow even" id="colTrip">' 
                            ...
                            +' <div class="zCell" style="width:120px;text-align:right;padding-right: 0.3rem;">&#8369; '+_tot.sales.toMoney()+'</div>'
                        +'</div>'; 
                    }
                    if(_sqlCode==="P1442"){
                        _h  +=  '<div class="zRow even" id="colTrip">' 
                            ...
                            +' <div class="zCell" style="width:120px;text-align:center;"></div>'
                            +' <div class="zCell" style="width:120px;text-align:center;"></div>' 
                            +' <div class="zCell" style="width:120px;text-align:right;">Total Amount</div>'
                    ...
                    if(_sqlCode!=="P1443")  this.find("input").attr("readonly",true);
        ...
        if(_zRows.find(".zRow").length == 1){
            ...
            if(_tableRight.height() > _zRowsHeight){
                _tableRight.parent().scroll(function() { 
                    ...
                    else if(gSubTabName==="Collection Summary"){
